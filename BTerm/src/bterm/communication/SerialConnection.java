...
public class SerialConnection {
    ...
    public boolean connect(String portName,String speed, String dataBit,
     ...
     * @throws Exception 
     */
    public void drawChart(BTermLineChart chart) throws Exception{
